      ...
      <section className="bg-white px-8 py-6 max-w-lg shadow-md fixed z-30 rounded-md top-2/4 left-2/4 transform -translate-y-2/4 -translate-x-2/4">
        ...
        <form>
          <label className="mt-4 block">
            ...
            <input
              className="autofocus w-full rounded-md  border-1 border-bg-black shadow-md transform focus:-translate-y-1 focus:shadow-xl focus:bg-white duration-300 px-4 py-1 border-b border-black"
              name="name"
              type="text"
